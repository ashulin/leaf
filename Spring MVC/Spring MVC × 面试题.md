...
> **流程示意图**：
>
> ![流程示意图](http://static2.iocoder.cn/images/Spring/2022-02-21/01.png)
>
> **代码序列图**：
>
...
> **流程示意图**：
>
> ![《流程示意图》](http://static2.iocoder.cn/images/Spring/2022-02-21/03.png)
...
```
// HandlerExceptionResolver.javapublic interface HandlerExceptionResolver {    /**     * 解析异常，转换成对应的 ModelAndView 结果     */    @Nullable    ModelAndView resolveException(            HttpServletRequest request, HttpServletResponse response, @Nullable Object handler, Exception ex);}
```
